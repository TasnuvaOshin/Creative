...
$user_id = $_GET['id'];
		    	...
		    	$sql = "SELECT * FROM `rx_data` WHERE pso_ffc='$user_id' AND  n_date >= DATE_ADD(LAST_DAY(DATE_SUB(NOW(), INTERVAL 2 MONTH)), INTERVAL 1 DAY) AND n_date <= DATE_ADD(LAST_DAY(DATE_SUB(NOW(), INTERVAL 1 MONTH)), INTERVAL 0 DAY)";
